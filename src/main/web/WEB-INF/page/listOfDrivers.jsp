...
<table border="1px" cellpadding="0" cellspacing="0" >
    ...
    <c:forEach var="driver" items="${drivers}">
        <tr>
            ...
            <td>
                <a href="${pageContext.request.contextPath}/driver/edit/${driver.id}.html">Edit</a><br/>
                <a href="${pageContext.request.contextPath}/driver/delete/${driver.id}.html">Delete</a><br/>
            </td>
        </tr>
    </c:forEach>
    </tbody>
